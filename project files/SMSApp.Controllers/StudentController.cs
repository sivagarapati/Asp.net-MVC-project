namespace SMSApp.Controllers
{
    ...
    public class StudentController : BaseController
    {
        ...
        {
            StudentFee myobj = new StudentFee();
            myobj.AdmissionNumber = SessionManager.LoginUserInfo.UserID.ToStr();
            myobj.RollNumber  = SessionManager.LoginUserInfo.MembershipID .ToStr();
            myobj.SchoolName = "missouri";
            myobj.LocationName = "USA";
            Random r = new Random();
            int ran = r.Next();
            myobj.FeeReceiptNumber = ran.ToStr();
            return View(myobj);
        }
